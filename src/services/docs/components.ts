    ...
    "schemas": {
        "Role": {
            ...
            "properties": {
                ...
                "createdAt": {
                    "type": "string",
                    "description": "The date the role was created (Auto-generated)"
                },
                "updatedAt": {
                    "type": "string",
                    "description": "The date the role was updated (Automatically updated)"
                },
                "description": {
                    "type": "string",
        ...
        "Permission": {
            ...
            "properties": {
                ...
                "createdAt": {
                    "type": "string",
                    "description": "The date the permission was created (Auto-generated)"
                },
                "updatedAt": {
                    "type": "string",
                    "description": "The date the permission was updated (Automatically updated)"
                }
            },
            "example": {
        ...
        "User": {
            ...
            "properties": {
                ...
                "password": {
                    "type": "string",
                    "description": "The password of the user (Only for registration with local strategy)"
                },
                "roleId": {
                    "type": "string",
                    "description": "The ID of the associated role"
                ...
                "googleId": {
                    "type": "string",
                    "description": "The Google ID of the user (Saved automatically when using Google auth)"
                },
                "createdAt": {
                    "type": "string",
                    "description": "The date the user was created (Automatically created)"
                },
                "updatedAt": {
                    "type": "string",
                    "description": "The date the user was updated (Automatically updated)"
                },
                "lastLogin": {
                    "type": "string",
                    "description": "The date the user last logged in (Automatically updated)"
                },
                "isActive": {
                    "type": "boolean",
        ...
        "RefreshToken": {
            "type": "object",
            "required": ["userId", "token", "userAgent", "ipAddress", "expiresAt"],
            "properties": {
                "id": {
                    "type": "string",
                ...
                "expiresAt": {
                    "type": "string",
                    "description": "The expiration date of the token (Value in milliseconds)"
                }
            },
            "example": {
